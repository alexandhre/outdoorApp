...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Cadastrar Outdoor</h1>
        </div>
      </div>
      <!-- /.row -->
    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <form action="{{ route('storeOut') }}" method="post">
          @csrf
              ...
              <div role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="contratante" id="contratante" placeholder="Digite o Contratante">
                  </div>
                   <!-- /.form group -->
                   <div class="form-group">
                    <label for="situacao">Situação</label>
                    <input type="text" class="form-control" name="situacao" id="situacao" placeholder="Digite a Situação">
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
